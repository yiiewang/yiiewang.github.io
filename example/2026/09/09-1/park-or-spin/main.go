...
// 用法：
//
//	go run ./2026/09/09-1/park-or-spin -exp=stall  -procs=1
//	go run ./2026/09/09-1/park-or-spin -exp=stall  -procs=2
//	go run ./2026/09/09-1/park-or-spin -exp=ladder -procs=1
//	go run ./2026/09/09-1/park-or-spin -exp=ladder -procs=2
package main
