...
type UserClient interface {
	...
	CheckPasswd(ctx context.Context, in *PasswdCheckInfo, opts ...grpc.CallOption) (*CheckResponse, error)
}
...
func (c *userClient) CheckPasswd(ctx context.Context, in *PasswdCheckInfo, opts ...grpc.CallOption) (*CheckResponse, error) {
	out := new(CheckResponse)
	err := c.cc.Invoke(ctx, "/User/CheckPasswd", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	CheckPasswd(context.Context, *PasswdCheckInfo) (*CheckResponse, error)
...
func (UnimplementedUserServer) CheckPasswd(context.Context, *PasswdCheckInfo) (*CheckResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CheckPasswd not implemented")
}
...
func _User_CheckPasswd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PasswdCheckInfo)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).CheckPasswd(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/User/CheckPasswd",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).CheckPasswd(ctx, req.(*PasswdCheckInfo))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "CheckPasswd",
			Handler:    _User_CheckPasswd_Handler,
		},
	},
