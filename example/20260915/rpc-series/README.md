...
# 01: HTTP + JSON
go run ./20260915/rpc-series/01-http-rpc/server   # 终端 A
go run ./20260915/rpc-series/01-http-rpc/client   # 终端 B → 3

# 02: net/rpc（gob 编码，裸 TCP）
go run ./20260915/rpc-series/02-netrpc/server
go run ./20260915/rpc-series/02-netrpc/client     # hello,cloaks

# 03: net/rpc + JSON 编码
go run ./20260915/rpc-series/03-jsonrpc/server
go run ./20260915/rpc-series/03-jsonrpc/client

# 04: JSON-RPC over HTTP（可以直接用 curl 调）
go run ./20260915/rpc-series/04-http-jsonrpc/server
...
go run ./20260915/rpc-series/05-stub/server
go run ./20260915/rpc-series/05-stub/client
```
